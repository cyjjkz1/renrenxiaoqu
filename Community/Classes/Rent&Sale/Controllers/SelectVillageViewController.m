...
@interface SelectVillageViewController ()<UITableViewDelegate, UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    [tableView registerClass:[DropViewCell class] forCellReuseIdentifier:@"villageCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    DropViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"villageCell" forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    for (UIView *vi in cell.contentView.subviews) {
        if ([vi isKindOfClass:[UILabel class]]) {
            ...
            NSLog(@"%@",label.text);
            [kNotificationCenter postNotificationName:kNotification_SelectedVillage object:self userInfo:@{@"title":label.text}];
        }
    }
