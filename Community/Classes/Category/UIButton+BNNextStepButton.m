...
-(void)setuporangeBtnTitle:(NSString *)title enable:(BOOL)enable
{
    ...
    UIImage *image1 = [Tools imageWithColor:UIColorFromRGB(0x0080ff) andSize:CGSizeMake(SCREEN_WIDTH, 50*BILI_WIDTH)];
    UIImage *image2 = [Tools imageWithColor:UIColor_Button_Disable andSize:CGSizeMake(SCREEN_WIDTH, 50*BILI_WIDTH)];
//    UIImage *image3 = [Tools imageWithColor:UIColor_LightBlueButtonBGHighLight andSize:CGSizeMake(SCREEN_WIDTH, 50*BILI_WIDTH)];
...
-(void)setupWhiteBtnTitle:(NSString *)title enable:(BOOL)enable
{
    self.layer.cornerRadius = 4;
    self.layer.masksToBounds = YES;
    [self.titleLabel setFont:[UIFont systemFontOfSize:[BNTools sizeFit:15 six:17 sixPlus:19]]];
    ...
    UIImage *image1 = [Tools imageWithColor:[UIColor whiteColor] andSize:CGSizeMake(SCREEN_WIDTH, 50*BILI_WIDTH)];
    UIImage *image2 = [Tools imageWithColor:UIColor_Button_Disable andSize:CGSizeMake(SCREEN_WIDTH, 50*BILI_WIDTH)];
    //    UIImage *image3 = [Tools imageWithColor:UIColor_LightBlueButtonBGHighLight andSize:CGSizeMake(SCREEN_WIDTH, 50*BILI_WIDTH)];
