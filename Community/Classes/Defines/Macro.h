...
#define BaseWidth  (isIPhone?320.0:768.0)
#define BaseHeight  (isIPhone?568.0f:1024.0)

#define AdaptWidth(__width) (__width/BaseWidth)*kScreenWidth
#define AdaptHeight(__height) (__height/BaseHeight)*kScreenHeight
